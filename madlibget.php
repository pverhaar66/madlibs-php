...
<body>
	<main>
	<section id="section2">
	<p>You walk over some beautiful plains while licking a <?php echo $_GET["candy"]; ?>,  after some time you come across a rlly ugly looking <?php echo $_GET["object"]; ?> it steals your <?php echo $_GET["candy"]; ?> and it eats it infront of you. you <?php echo $_GET["anything"]; ?> in the meantime the <?php echo $_GET["object"]; ?> was listening to <?php echo $_GET["music"]; ?> and not paying attention to u at all,  u get infuriated and get the the almighty weapon <?php echo $_GET["weapon"]; ?> 
